    ...
    <svg className="w-40 h-40 shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 10 211.73 180">
        <defs>
            <linearGradient id="linear-gradient-hair" x1="102.94" y1="154.47" x2="102.94" y2="36.93" gradientUnits="userSpaceOnUse">
                <stop offset="0" stopColor="#7e5582"></stop>
                <stop offset="0.01" stopColor="#7e5582"></stop>
                <stop offset="0.54" stopColor="#77655a"></stop>
                <stop offset="1" stopColor="#77655a"></stop>
            </linearGradient>
        ...
        <g clipPath="url(#clip-path)">
            <g id="me" data-name="me" data-svg-origin="102.23083877563477 199.74785232543945" transform="matrix(1,0,0,1,0,0)" style={{ opacity: 1, transformOrigin: '0px 0px' }}>
                <g id="body">
                    ...
                    <path id="top" d="M105.61 167c-30.17 0-25.36-40-25.36 15.84h25.35l25-2.14c-.05-55.79 5.17-13.7-24.99-13.7z" fill="#fff" stroke="#404040" strokeMiterlimit="10" strokeWidth="0.5"></path>
